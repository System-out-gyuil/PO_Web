...
class Command(BaseCommand):
    ...
    def extract_structured_data(self, text):
        prompt = (
                ...
                "  \"사업기간(업력)\": [\"사업자 등록 전\",\"3년 미만\",\"3년 이상\" 중 선정 가능성이 높은 구간을 복수 선택,\n"
                "  \"매출규모\": [\"매출 없음\", \"1억 이하\",\"1~5억\",\"5~10억\",\"10~30억\",\"30억 이상\" 중 선정 가능성이 높은 구간을 복수 선택],\n"
                "  \"수출실적여부\": [\"수출 기업\",\"수출 희망\", \"내수 기업\" 반드시 예시 중 선정 가능성이 높은 선택지를 복수 선택],\n"
                "  \"공고내용\": \"지원 목적, 대상, 기간, 방법, 자부담, 선정 절차, 지원 한도 및 제한 사항 등을 종합하여 450자 이상으로 정밀하게 요약한 문장\"\n"
                "  \"가능업종\": [ \"농업, 임업 및 어업\", \"광업\", \"제조업\", \"전기, 가스, 증기 및 공기 조절 공급업\", \"수도, 하수 및 폐기물 처리, 원료 재생업\", \"건설업\", \"도매 및 소매업\", \"운수 및 창고업\", \"숙박 및 음식점업\", \"정보통신업\", \"금융 및 보험업\", \"부동산업\", \"전문, 과학 및 기술 서비스업\", \"사업시설 관리, 사업 지원 및 임대 서비스업\", \"교육서비스업\", \"보건업 및 사회복지 서비스업\", \"예술 스포츠 및 여가관련 서비스업\", \"협회 및 단체, 수리 및 기타 개인서비스업\" 중 지금 만든 공고내용요약에서 명확히 지원 대상에 해당하는 업종 복수 선택 반드시 예시업종 중 선택할 것],\n"
                "}\n\n"
                "필수 준수사항:\n"
