...
class Command(BaseCommand):
    ...
    def extract_structured_data(self, text):
        prompt = (
                ...
                "  \"직원수\": [\"1~4인\",\"5인 이상\" 중 실제 선정 가능성이 높은 범위를 모두 선택],\n"
                "  \"사업기간(업력)\": [\"예비 창업\",\"1년 이하\",\"1~3년\",\"3~7년\",\"7년 이상\" 중 원문 근거로 가장 보수적인 하나 선택],\n"
                "  \"매출규모\": [\"1억 이하\",\"1~5억\",\"5~10억\",\"10~30억\",\"30억 이상\" 중 지원 가능성이 높은 구간을 복수 선택],\n"
                "  \"가능업종\": [\"제조업\",\"서비스업\",\"요식업\",\"IT\",\"도소매\",\"건설업\",\"무역업\",\"운수업\",\"농수산업\",\"미디어\" 중 원문에서 명확히 지원 대상으로 보이는 업종 복수 선택],\n"
                "  \"수출실적여부\": [\"수출기업\",\"수출 희망\" 중 원문에서 실제 언급된 것만 선택],\n"
