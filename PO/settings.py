...
ALLOWED_HOSTS = ['localhost', '172.30.1.19', '127.0.0.1', '13.124.116.146', '43.203.40.252', 'namatji.com', 'www.namatji.com', 'xn--jj0bw47b70a.com']
...
CRONJOBS = [
    ('* 18 * * *', 'PO.cron.update_bizinfo'), #매일 18시
    ('0 8 * * 1', 'PO.cron.update_biztop'), #매주 월요일 08시
]
